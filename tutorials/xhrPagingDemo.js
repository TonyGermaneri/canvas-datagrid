...
function demo() {
    'use strict';
    var grid, schemaCache, dataCache, searchUrl = window.location.search.substring(3),
        typeMap = {
            'text': 'string',
            'money': 'number',
            'number': 'number'
    ...
    function loadDataSet(url) {
        ...
        xhr.addEventListener('load', function (e) {
            ...
            schemaCache = openData.schema;
            // because this demo does not have an actual paging API it can call, it will simulate it with this data cache.
            dataCache = openData.data;
