    ...
    function addDefaultContextMenuItem(e) {
      ...
      if (self.attributes.showColumnSelector) {
        ...
        if (e.cell && e.cell.header && e.cell.columnIndex > -1) {
          e.items.push({
            title: self.attributes.hideColumnText.replace(/%s/ig, e.cell.header.title || e.cell.header.name),
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function () {
  ...
  return function (self) {
    self.defaults = {
      attributes: [['allowColumnReordering', true], ['allowColumnResize', true], ['allowColumnResizeFromCell', false], ['allowFreezingRows', false], ['allowFreezingColumns', false], ['allowMovingSelection', true], ['allowRowHeaderResize', true], ['allowRowReordering', false], ['allowRowResize', true], ['allowRowResizeFromCell', false], ['allowSorting', true], ['autoGenerateSchema', false], ['autoResizeColumns', false], ['blanksText', '(Blanks)'], ['borderDragBehavior', 'none'], ['borderResizeZone', 10], ['clearSettingsOptionText', 'Clear saved settings'], ['columnHeaderClickBehavior', 'sort'], ['columnSelectorHiddenText', '&nbsp;&nbsp;&nbsp;'], ['columnSelectorText', 'Add/Remove columns'], ['columnSelectorVisibleText', "\u2713"], ['contextHoverScrollAmount', 2], ['contextHoverScrollRateMs', 5], ['copyHeadersOnSelectAll', true], ['copyText', 'Copy'], ['debug', false], ['editable', true], ['ellipsisText', '...'], ['filterOptionText', 'Filter %s'], ['filterTextPrefix', '(filtered) '], ['globalRowResize', false], ['hideColumnText', 'Hide %s'], ['maxAutoCompleteItems', 200], ['multiLine', false], ['name', ''], ['pageUpDownOverlap', 1], ['pasteText', 'Paste'], ['persistantSelectionMode', false], ['removeFilterOptionText', 'Remove filter on %s'], ['reorderDeadZone', 3], ['resizeScrollZone', 20], ['rowGrabZoneSize', 5], ['saveAppearance', true], ['scrollAnimationPPSThreshold', 0.75], ['scrollPointerLock', false], ['scrollRepeatRate', 75], ['selectionFollowsActiveCell', false], ['selectionHandleBehavior', 'none'], ['selectionMode', 'cell'], ['selectionScrollIncrement', 20], ['selectionScrollZone', 20], ['showClearSettingsOption', true], ['showColumnHeaders', true], ['showColumnSelector', true], ['showCopy', false], ['showFilter', true], ['showNewRow', false], ['showOrderByOption', true], ['showOrderByOptionTextAsc', 'Order by %s ascending'], ['showOrderByOptionTextDesc', 'Order by %s descending'], ['showPaste', false], ['showPerformance', false], ['showRowHeaders', true], ['showRowNumbers', true], ['singleSelectionMode', false], ['snapToRow', false], ['touchContextMenuTimeMs', 800], ['touchDeadZone', 3], ['touchEasingMethod', 'easeOutQuad'], ['touchReleaseAcceleration', 1000], ['touchReleaseAnimationDurationMs', 2000], ['touchScrollZone', 20], ['touchSelectHandleZone', 20], ['touchZoomSensitivity', 0.005], ['touchZoomMin', 0.5], ['touchZoomMax', 1.75], ['maxPixelRatio', 2], ['tree', false], ['treeHorizontalScroll', false]],
    ...
    self.beginEditAt = function (x, y, NativeEvent) {
      ...
      self.input.addEventListener('keydown', function (e) {
        ...
        if (e.key === "Escape") {
          self.endEdit(true);
          self.draw(true);
        } else if (e.key === "Enter" && (!self.attributes.multiLine || self.attributes.multiLine && e.shiftKey)) {
          self.endEdit(); // Move to cell in next row
...
/*globals define: true, MutationObserver: false, requestAnimationFrame: false, performance: false, btoa: false*/
var isPrintableKeyEvent = __webpack_require__(/*! is-printable-key-event */ "./node_modules/is-printable-key-event/dist/index.js");
    ...
    self.mousemove = function (e, overridePos) {
      ...
      if (!self.draggingItem && o && self.scrollModes.indexOf(o.context) === -1) {
        ...
        if ((self.selecting || self.reorderObject) && o.context === 'cell') {
          ...
          if (self.dragStartObject.rowIndex !== o.rowIndex || self.dragStartObject.columnIndex !== o.columnIndex) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./component */ "./lib/component.js"), __webpack_require__(/*! ./defaults */ "./lib/defaults.js"), __webpack_require__(/*! ./draw */ "./lib/draw.js"), __webpack_require__(/*! ./events */ "./lib/events.js"), __webpack_require__(/*! ./touch */ "./lib/touch.js"), __webpack_require__(/*! ./intf */ "./lib/intf.js"), __webpack_require__(/*! ./contextMenu */ "./lib/contextMenu.js"), __webpack_require__(/*! ./dom */ "./lib/dom.js"), __webpack_require__(/*! ./publicMethods */ "./lib/publicMethods.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function context(component) {
  'use strict';
