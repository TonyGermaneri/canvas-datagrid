...
export default function (self) {
        ...
        if (
          ...
          if (
            ...
            if (cell.hovered && self.hovers.onFilterButton) {
              ...
              self.cellTreeExpandCollapse(cell.rowIndex, cell.columnIndex);
              return;
            } else {
              self.selectedFilterButton = {
                columnIndex: -1,
  ...
  self.click = function (e, overridePos) {
    ...
    if (
      ...
      if (!self.hovers.onFilterButton && !self.hovers.onCellTreeIcon) {
  ...
  self.mousedown = function (e, overridePos) {
    ...
    if (
      ...
      if (
        ...
        !(
          self.currentCell.hovered &&
          (self.hovers.onFilterButton || self.hovers.onCellTreeIcon)
        )
      ) {
        self.selections = [];
      }
