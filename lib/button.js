...
export default function (self) {
  ...
  function createButton(pos, items, imgSrc) {
    ...
    function init() {
      ...
      wrapper.addEventListener('click', toogleButtonMenu);
    }
  ...
  function createButtonMenu(pos, items) {
        ...
        function addItem(item) {
          function addContent(content) {
            ...
            if (typeof content === 'object') {
              buttonMenuItemContainer.appendChild(content);
              return;
            }

            applyButtonMenuItemStyle(buttonMenuItemContainer);
            buttonMenuItemContainer.innerHTML = content;
            return;
          }

          addContent(item.title);
          item.buttonMenuItemContainer = buttonMenuItemContainer;

          if (item.click) {
            buttonMenuItemContainer.addEventListener('click', function (ev) {
    ...
    function init() {
      ...
      rect = buttonMenu.getBoundingClientRect(); // TODO: fix
