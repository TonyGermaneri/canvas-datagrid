...
export default function (self, ctor) {
  ...
  self.getSelectionBoundIndexMaps = function () {
    const boundRowIndexMap = {};
    const boundColumnIndexMap = {};

    self.selections.forEach(function (row, rowIndex) {
      if (row) {
        boundRowIndexMap[rowIndex] = self.getBoundRowIndexFromViewRowIndex(
          rowIndex,
        );
    ...
    return { boundRowIndexMap, boundColumnIndexMap };
  };
