 ...
 * @param {boolean} [args.disableRowOrdering=false] - When true rows order is not kept track of.  This is helpful for very large datasets (> 10^6 records).
 * @param {boolean} [args.disableRowResizing=false] - When true row heights are not kept track of.  This is helpful for very large datasets (> 10^6 records).
