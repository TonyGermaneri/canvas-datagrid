/**
 * Canvas Datagrid is a hierarchical canvas based web component.  
 * Throughout this document the several words will be used interchangeably.  
 * Canvas Datagrid will also be referred to simply as "grid".  Column and header are used interchangeably.
 ...
 * The grid can be created in a number of ways.<br><br>
 ...
 * Although the grid itself is pure canvas, there are some supporting elements of the grid that are HTMLElements.<br><br>
