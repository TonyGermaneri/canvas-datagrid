 ...
 * @param {boolean} [args.scrollPointerLock=true] - When true, clicking on the scroll box to scroll will cause the mouse cursor to disappear to prevent it from exiting the area observable to the grid.
 * @param {canvasDataGrid.style} [args.style={}] - Sets selected values in style.
 * @param {canvasDataGrid.filters} [args.filters={}] - Sets selected values in filters.  See {@tutorial filters}.
 * @param {canvasDataGrid.sorters} [args.sorters={}] - Sets selected values in sorters.  See {@tutorial sorters}.
 * @param {canvasDataGrid.formatters} [args.formatters={}] - Sets selected values in formatters.  See {@tutorial formatters}.
 ...
 * @property {cell} currentCell - Cell that the mouse moved over last.
 ...
 * @property {canvasDatagrid.schema} schema - Schema is optional.  Schema is an array of column objects.  If no schema is provided one will be generated from the data, in that case all data will be assumed to be string data. See {@tutorial schema}.
