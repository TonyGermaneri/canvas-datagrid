/**
 * Canvas Datagrid is a hierarchical canvas based web component.  The grid can be created in a number of ways.<ul>
 * <li>Web component by using the tag `&lt;canvas-datagrid&gt;&lt;/canvas-datagrid&gt;` anywhere in your document.</li>
 * <li>Web component by running `var foo = document.createElement('canvas-datagrid')`.  See more: {@link https://tonygermaneri.github.io/canvas-datagrid/docs/tutorial-webcomponent.html}.</li>
 * <li>Webpack3 universal module loader by adding one of many module loaders to your application code.</li>
 * <li>AMD module loader.  See more: {@link https://tonygermaneri.github.io/canvas-datagrid/tutorials/amdDemo.html}.</li>
 * <li>You can also load the grid by invoking the global method `var foo = canvasDatagrid(&lt;args&gt;);`</li></ul>
 ...
 * Read the extensive tutorials section or view a demo and check the links in the "see other" section below.
 * @class
 * @name canvasDatagrid
