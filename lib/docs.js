 ...
 * @param {boolean} [args.schema=[]] - Sets the schema. See {@link canvasDatagrid.schema}.
 * @param {boolean} [args.data=[]] - Sets the data. See {@link canvasDatagrid.data}.
 ...
 * @property {string} [borderCollapse=collapse] - Style of borderCollapse.  When border collapse is set to the default value of `collapse`, the bottom border and the top border of the next cell down will be merged into a single border.  The only other setting is `expand` which allows the full border to be drawn.
