 ...
 * @param {string} [args.showGroupColums='Group columns %s'] - Text that appears on the group columns option.
 * @param {string} [args.showGroupRows='Group row %s'] - Text that appears on the group rows option.
 * @param {string} [args.showRemoveGroupColums='Remove group %s'] - Text that appears on the remove columns group option.
