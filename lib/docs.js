 ...
 * You can use the grid as a web component by using the tag `&lt;canvas-datagrid&gt;&lt;/canvas-datagrid&gt;` anywhere in your document.<br>
 * You can create the web component by running `var foo = document.createElement('canvas-datagrid')` {@link https://tonygermaneri.github.io/canvas-datagrid/docs/tutorial-webcomponent.html}.<br>
 * You can use the Webpack3 universal module loader by adding one of many module loaders to your application code.<br>
 * Here is an example using AMD module loader {@link https://tonygermaneri.github.io/canvas-datagrid/tutorials/amdDemo.html}.<br>
 * You can also load the grid by invoking the global method `var foo = canvasDatagrid(&lt;args&gt;);`<br><br>
 ...
 * No matter how you create it, the grid will attempt to create a Shadow DOM element and attach a canvas within.
 ...
 * In order to capture keystrokes, a hidden input is placed outside of the visible area of the web page to capture keystroke and translate them into grid commands, such as cursor navigation.<br><br>
 * You can customize almost every behavior of the grid by subscribing to an event the event handler collection.  Most events have `e.preventDefault();` that will allow you to manipulate the grid's behavior on a very granular level.
