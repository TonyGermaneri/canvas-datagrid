...
export default function (self) {
  self.defaults = {
    attributes: [
      ...
      ['showGroupColums', 'Group columns %s'],
      ['showGroupRows', 'Group row %s'],
      ['showRemoveGroupColums', 'Remove group %s'],
    ...
    styles: [
      ...
      ['gridBorderWidth', 1],
      ['grounpIndicatorColor', 'rgba(155, 155, 155, 1)'],
      ['grounpIndicatorBackgroundColor', 'rgba(255, 255, 255, 1)'],
      ['height', 'auto'],
      ['maxHeight', 'inherit'],
      ['maxWidth', 'inherit'],
      ['minColumnWidth', 45],
