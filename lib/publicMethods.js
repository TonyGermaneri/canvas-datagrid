...
export default function (self) {
  ...
  self.insertColumn = function (c, index) {
    ...
    self.refresh();
    self.dispatchDataChanged('insertcolumn', { column: c, index: index });
  };
  /**
  ...
  self.deleteColumn = function (index) {
    ...
    self.refresh();
    self.dispatchDataChanged('deletecolumn', { index: index });
  };
  /**
  ...
  self.addColumn = function (c) {
    ...
    self.refresh();
    self.dispatchDataChanged('addcolumn', { column: c });
  };
  /**
  ...
  self.deleteRow = function (index) {
    ...
    self.setFilter();
    self.resize(true);
    self.dispatchDataChanged('deleterow', { index: index });
  };
  /**
  ...
  self.insertRow = function (d, index) {
    ...
    self.resize(true);
    self.dispatchDataChanged('insertrow', { row: d, index: index });
  };
  /**
  ...
  self.addRow = function (d) {
    ...
    self.resize(true);
    self.dispatchDataChanged('addrow', { row: d });
  };
  /**
  ...
  self.dispatchDataChanged = function (source, details) {
    self.dispatchEvent(
      'datachanged',
      Object.assign({ data: self.originalData, source: source }, details || {}),
    );
  };
  /**
          ...
          if (
            (!self.isColumnSelected(cell.columnIndex) &&
              cell.x +
                ...
                x) ||
            !self.attributes.allowColumnReordering
          ) {
