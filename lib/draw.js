...
export default function (self) {
   ...
   */
  function drawUnhideIndicator(x, y, size, dir, closed, active) {
      ...
      return function drawEach(header, headerIndex, columnOrderIndex) {
        ...
        if (isColumnHeader && self.attributes.showUnhideColumnsIndicator) {
          ...
          const drawIndicator = (leftX, dir, active) => {
            ...
            drawUnhideIndicator(leftX, topY, size, dir, false, active);
        ...
        if (isRowHeader && self.attributes.showUnhideRowsIndicator) {
          // Leo's comment:
          ...
          if (rowIndex % 2 === 0) {
            ...
            drawIndicator(indicatorY, 'b', active);
          }
          if (rowIndex % 2 === 1) {
            const active = true;
            const indicatorY = cellY + cell.height - size;
            drawIndicator(indicatorY, 't', active);
          }
        }
