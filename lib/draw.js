...
export default function (self) {
  ...
  self.draw = function (internal) {
    ...
    function createBorderOverlayArray(
      ...
      if (!cell.isRowHeader && isSelected(cell.rowIndex, cell.columnIndex)) {
        if (
          (!isSelected(cell.rowIndex - 1, cell.columnIndex) ||
            cell.rowIndex === 0) &&
          !cell.isHeader
        ) {
        ...
        if (!isSelected(cell.rowIndex + 1, cell.columnIndex)) {
        ...
        if (
          cell.columnIndex === 0 ||
          !isSelected(cell.rowIndex, cell.columnIndex - 1)
        ) {
