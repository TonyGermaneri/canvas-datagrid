    ...
    function grid(args) {
            ...
            function drawCell(d, rowIndex, rowOrderIndex) {
                return function drawEach(header, headerIndex, columnOrderIndex) {
                    var cellStyle = header.style || 'cell',
                        ...
                        activeHeader = (activeCell.rowIndex === rowOrderIndex || activeCell.columnIndex === columnOrderIndex)
        ...
        function tryLoadStoredOrders() {
            if (storedSettings && typeof storedSettings.orders === 'object') {
                ...
                if (storedSettings.orders.columns.length >= getSchema().length) {
