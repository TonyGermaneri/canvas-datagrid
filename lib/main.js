...
(window.define || function defineStub(a, b) {
    ...
    function grid(args) {
            ...
            function drawRow(r) {
                ...
                if (r !== data.length - 1 && rowOpen) {
                    ...
                    treeGrid.childGridContainer.style.top =
                        position(container).top + y + style.cellHeight + 'px';
        ...
        function clipElement(ele) {
            var e,
                boundingRect = position(container),
                clipRect = {
                    x: 0,
                    y: 0,
                    h: 0,
            ...
            if (clipRect.x >= ele.offsetWidth || clipRect.w <= 0) {
        ...
        function expandTree(rowIndex) {
            ...
            childGrids[rowId].originalRowHeight = sizes.rows[data[rowIndex][uniqueId]];
        ...
        function attachCss() {
            var styleSheet, css = [
                ...
                '.canvas-datagrid { z-index: 1;box-sizing: content-box!important; padding: 0!important; }',
