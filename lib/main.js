    ...
    function grid(args) {
        ...
        var defaultAttributes = [
            ...
            defaultStyles = [
                ...
                ['reorderMarkerIndexBorderWidth', 1.75],
        ...
        function draw(internal) {
            ...
            function drawRow(r, d) {
                ...
                if (attributes.rowSelectionMode
                    ...
                    ctx.lineWidth = style.activeCellOverlayBorderWidth;
                    ctx.strokeStyle = style.activeCellOverlayBorderColor;
                    strokeRect(headerCellWidth, y, width - headerCellWidth, rowHeight);
                }
            ...
            function drawRows() {
                ...
                if (attributes.showNewRow) {
                    ...
                    for (o = scrollIndexLeft; o < g; o += 1) {
                        i = orders.columns[o];
                        x += drawCell(newRow, data.length, o)(s[i], i, o);
                        if (x > width + scrollBox.scrollLeft) {
                            break;
                        }
                    }
            ...
            if (attributes.saveAppearance && attributes.showClearSettingsOption
                ...
                menuItems.push({
                    ...
                    click: function (e) {
                        ...
                        orders.columns = fillArray(0, getSchema().length - 1);
        ...
        function init() {
            ...
            Object.defineProperty(intf, 'schema', {
                ...
                set: function schemaSetter(value) {
                    ...
                    createNewRowData();
                    resize(true);
                    orders.columns = fillArray(0, schema.length - 1);
                    tryLoadStoredOrders();
            ...
            Object.defineProperty(intf, 'data', {
                ...
                set: function dataSetter(value) {
                    ...
                    if (tempSchema && !schema) {
                        orders.columns = fillArray(0, tempSchema.length - 1);
                        tryLoadStoredOrders();
