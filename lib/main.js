...
(window.define || function defineStub(a, b) {
    ...
    function grid(args) {
        ...
        function draw(internal) {
                ...
                return function drawEach(header, headerIndex) {
                    ...
                    if (!dispatchEvent('beforerendercell', [ctx, d[header.name], d, header, cx, cy], intf)) {
                        ...
                        cell = {
                            ...
                            offsetTop: cy,
                            offsetLeft: cx,
                            canvasOffsetTop: cy + canvasOffsetTop,
                            canvasOffsetLeft: cy + canvasOffsetLeft,
            ...
            function drawRow(r) {
                ...
                if (r !== data.length && rowOpen) {
                    ...
                    treeGrid.parentNode = {
                        ...
                        offsetParent: intf,
                        parentNode: intf,
                        canvasOffsetTop: cy + canvasOffsetTop + rowSansTreeHeight,
                        canvasOffsetLeft: cx + canvasOffsetLeft + headerCellWidth,
                        style: style
                    };
                    treeGrid.draw();
                } else if (treeGrid) {
            ...
            canvasOffsetTop = isChildGrid ?
                    parentNode.canvasOffsetTop : 0;
            canvasOffsetLeft = isChildGrid ?
                    parentNode.canvasOffsetLeft : 0;
            x = 0;
            ...
            if (attributes.showPerformance) {
                ...
                ctx.fillStyle = 'black';
                fillText(('it: %s, pt: %s, cl: %s, ct: %s, x: %s, y: %s, w: %s, h: %s, bw: %s, bh: %s, sw: %s, sh: %s, sl: %s, st: %s, f: %s, c: %s')
