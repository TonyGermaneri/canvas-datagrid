 ...
 * @param {boolean} [args.multiLine=true] - When true, edit cells will be textareas, when false edit cells will be inputs.
 ...
 * @param {boolean} [args.schema=[]] - Sets the schema. See schema property below.
 * @param {boolean} [args.data=[]] - Sets the data. See data property below.
