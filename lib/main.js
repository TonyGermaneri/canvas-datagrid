    ...
    function grid(args) {
        ...
        function mousemove(e) {
            ...
            if (!resizingItem
                ...
                if (selecting
                    ...
                    if (setTimer && !ctrl && o.columnIndex !== -1) {
        ...
        function mousedown(e) {
            ...
            if (['ns-resize', 'ew-resize'].indexOf(resizeMode) === -1) {
                ...
                if (resizeItem.style === 'headerCell') {
                    resizeMode = 'reordercolumn';
                }
                if (resizeItem.style === 'rowHeaderCell') {
                    resizeMode = 'reorderrow';
                }
            }
            if (['ns-resize', 'ew-resize'].indexOf(resizeMode) !== -1) {
                resizingItem = resizeItem;
