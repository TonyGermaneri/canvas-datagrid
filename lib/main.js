    ...
    function grid(args) {
        ...
        var defaultAttributes = [
            ...
            defaultStyles = [
                ...
                ['headerOrderByArrowColor', 'rgba(160, 160, 160, 1)'],
                ['headerOrderByArrowBorderColor', 'rgba(80, 80, 80, 1)'],
                ...
                ['activeCellBackgroundColor', 'rgba(151, 154, 188, 1)'],
                ['activeCellHoverColor', 'rgba(43, 48, 153, 1)'],
                ['activeCellHoverBackgroundColor', 'rgba(151, 154, 188, 1)'],
                ...
                ['headerCellBorderColor', 'rgba(215, 221, 221, 1)'],
                ...
                ['headerRowCellBorderColor', 'rgba(215, 221, 221, 1)'],
        ...
        function draw() {
            ...
            var newRow, t, rowHeaderCell, p, cx, cy, cellHeight, cornerCell, y, x, c, h, w, s, end;
        ...
        function attachCss() {
            var styleSheet, css = [
                '.canvas-datagrid-edit-textarea { padding: 2px; font-size: '
                    + style.editCellFontSize + '; font-family: '
                    + style.editCellFontFamily + '; }',
                '.canvas-datagrid-context-menu-item { margin: 2px; }',
                '.canvas-datagrid-context-menu-label { display: inline-block; min-width: 75px; }',
                '.canvas-datagrid-context-menu { font-family: sans-serif; background: #CCC; border: 1px solid #555; padding: 2px; border-radius: 3px; opacity: 0.97;}',
                '.canvas-datagrid-invalid-search-regExp { background: #E99; }'
            ].join('\n');
