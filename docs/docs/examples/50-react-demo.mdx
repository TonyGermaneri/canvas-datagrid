...
- The named type imports need canvas-datagrid 0.5.0 or later, where `dist/types.d.ts` became a module. With 0.4.7 add `declare module 'canvas-datagrid';` to a `.d.ts` file in your project.
